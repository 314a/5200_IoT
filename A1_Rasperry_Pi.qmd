# Raspberry Pi\index{Raspberry Pi}
...
![Shell über die Softwareleiste öffnen](images/raspberry_pi_shell.jpg){.column-margin #fig-shell}
...
## Raspberry Pi im Netzerk auffinden
