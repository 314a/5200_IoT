# E02 Spektralmessung {.unnumbered}
...
[![ams Spectral ID iSPI Eval Kit](images/youtube_ams_as7262.png)](https://www.youtube.com/embed/KKyHxXyaVPM?si=hvO1IVbdwbjnDI40)
:::
...
- Kontrolliere, ob die Library `as7262` installiert ist mit `python -c "import as7262"`. Installiere die Library mit `sudo pip3 install as7262` falls sie nicht installiert ist.
...
Startet das Script mit `python3 spectrum.py`. Mit `Ctrl+c` kann das Script wieder gestopppt werden. Die Ausgabe sollte in etwa so aussehen (gekürzt):
